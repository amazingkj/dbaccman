...
class TableService {
    ...
    fun getTables(database: String): List<TableInfo> {
        return useConnection { conn ->
            val sql = """
                SELECT
                    table_name as name,
    ...
    fun getTableColumns(database: String, table: String): List<ColumnInfo> {
        return useConnection { conn ->
            val sql = """
                SELECT
                    column_name as name,
    ...
    fun getIndexes(database: String, table: String): List<IndexInfo> {
        return useConnection { conn ->
            val sql = """
                SELECT
                    index_name as name,
    ...
    fun dropIndex(database: String, table: String, indexName: String) {
        useConnection { conn ->
